...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Qt_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("ede63266-ebff-546c-83e0-1c6fb6d0efc8"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Qt", artifacts_toml) for e in artifacts["Qt"]]
...
if best_platform === nothing
    @debug("Unable to load Qt; unsupported platform $(triplet(platform_key_abi()))")
else
